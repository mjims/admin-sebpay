      ...
      <div className="gap-4 grid">
        ...
        <div className="dash-header flex justify-between p-4 bg-white">
          ...
          <div className="flex items-center space-x-4">
            <div className="btn">
              <a href="/withdrawals/" className="bg-(image:--side-border) hover:bg-(image:--sebpay-gradient-hover) text-white p-2">Demandes de retraits</a>
            </div>
            <div className="">
              <a href="/withdrawals/approved" className="border border-(--link-simple-border) p-2 hover:bg-(--link-simple-bg-hover)">Retraits approuvés</a>
            </div>
          </div>
        </div>
      </div>
