...
export function WithdrawalsPendingTable() {
  ...
  const pendingWithdrawals = withdrawals?.filter(m => m.status === "pending") || [];
...
export function WithdrawalsApprovedTable() {
  ...
  const approvedWithdrawals = withdrawals?.filter(m => m.status === "approved") || [];
...
export function WithdrawalsRejectedTable() {
  ...
  const rejectedWithdrawals = withdrawals?.filter(m => m.status === "rejected") || [];
